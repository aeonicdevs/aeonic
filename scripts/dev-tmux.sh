...
R2_BUCKET_NAME="${R2_BUCKET_NAME:-aeonic-nexus-attachments-dev}"
NEXUS_ATTACHMENT_MAX_BYTES="${NEXUS_ATTACHMENT_MAX_BYTES:-10485760}"
...
tmux new-window -t "$SESSION_NAME" -n backend \
  "cd '$REPO_ROOT/backend' && APP_ENV=development ALLOWED_ORIGINS='$ALLOWED_ORIGINS' NEXUS_DNS_TARGET='$NEXUS_DNS_TARGET' AEONIC_DEV_DOMAIN_ALIASES='$NEXUS_HOSTNAME=$PATIENT_DOMAIN_ALIAS_TARGET' CLOUDFLARE_API_TOKEN='$CLOUDFLARE_API_TOKEN' CLOUDFLARE_ZONE_ID='$CLOUDFLARE_ZONE_ID' CLOUDFLARE_CUSTOM_HOSTNAME_SSL_METHOD='$CLOUDFLARE_CUSTOM_HOSTNAME_SSL_METHOD' CLOUDFLARE_CUSTOM_HOSTNAME_CA='$CLOUDFLARE_CUSTOM_HOSTNAME_CA' CLOUDFLARE_CUSTOM_HOSTNAME_ORIGIN='$CLOUDFLARE_CUSTOM_HOSTNAME_ORIGIN' CLOUDFLARE_CUSTOM_HOSTNAME_ORIGIN_SNI='$CLOUDFLARE_CUSTOM_HOSTNAME_ORIGIN_SNI' R2_ACCOUNT_ID='$R2_ACCOUNT_ID' R2_ACCESS_KEY_ID='$R2_ACCESS_KEY_ID' R2_SECRET_ACCESS_KEY='$R2_SECRET_ACCESS_KEY' R2_BUCKET_NAME='$R2_BUCKET_NAME' NEXUS_ATTACHMENT_MAX_BYTES='$NEXUS_ATTACHMENT_MAX_BYTES' .venv/bin/uvicorn app.main:app --reload$HOLD"
