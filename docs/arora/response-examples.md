...
The current paste included endpoint cards, language tabs, and status-code labels, but not the actual code sample bodies or response payloads. Paste the missing examples below the matching endpoint headings as you capture them.

Use this format for each example:

````md
## METHOD /v2/client/example
...
## Missing Response Example Checklist

- [x] `POST /v2/client/patients` - Create patient record
- [x] `GET /v2/client/patients` - List client patients
- [x] `GET /v2/client/patients/:patientId` - Get patient detail
- [x] `PATCH /v2/client/patients/:patientId` - Update patient record
- [x] `DELETE /v2/client/patients/:patientId` - Archive patient
- [x] `POST /v2/client/patients/:patientId/health-logs` - Write patient health logs
- [x] `GET /v2/client/patients/:patientId/health-logs` - List patient health logs
- [x] `POST /v2/client/patients/:patientId/onboarding-id` - Upload patient onboarding photo
- [x] `POST /v2/client/patients/:patientId/continuation-sessions` - Create continuation session
- [x] `GET /v2/client/categories` - List categories
- [x] `GET /v2/client/products` - List consult products
- [x] `GET /v2/client/products/:clientProductId` - Get product detail
- [x] `POST /v2/client/products` - Create client product or package
- [x] `PATCH /v2/client/products/:clientProductId` - Update client product or package
- [x] `DELETE /v2/client/products/:clientProductId` - Deactivate client product or package
- [x] `GET /v2/client/products/:clientProductId/forms` - List product forms
- [x] `GET /v2/client/products/:clientProductId/forms/:formKey` - Get product form detail
- [x] `GET /v2/client/products/forms` - List forms for multiple products
- [x] `POST /v2/client/orders` - Create product order
- [x] `GET /v2/client/orders` - List client orders
- [x] `GET /v2/client/orders/:orderId` - Get order detail
- [x] `PATCH /v2/client/orders/:orderId` - Cancel order
- [x] `DELETE /v2/client/orders/:orderId` - Cancel order with DELETE
- [x] `POST /v2/client/patients/:patientId/consults` - Create product order for patient
- [x] `GET /v2/client/orders/:orderId/forms` - List order forms
- [x] `GET /v2/client/orders/:orderId/forms/:formKey` - Get order form detail
- [x] `POST /v2/client/orders/:orderId/forms/submissions` - Submit order forms
- [x] `GET /v2/client/forms` - List order forms by query
- [x] `GET /v2/client/forms/:formKey` - Get order form detail by query
- [x] `POST /v2/client/forms/submissions` - Submit order forms by body orderId
- [x] `GET /v2/client/labs` - List lab products
- [x] `POST /v2/client/patients/:patientId/labs/submissions` - Upload lab results
- [x] `GET /v2/client/labs/:clientProductId` - Get lab detail
- [x] `POST /v2/client/labs/requests` - Create lab request
- [x] `POST /v2/client/patients/:patientId/visit-requests` - Create visit request
- [x] `GET /v2/client/visits` - List visit products
- [x] `GET /v2/client/patients/:patientId/visit-availability` - Get sync visit availability
- [x] `POST /v2/client/patients/:patientId/visits` - Book sync visit
- [x] `PATCH /v2/client/visits/:visitId` - Update sync visit
- [x] `DELETE /v2/client/visits/:visitId` - Cancel sync visit
- [x] `POST /v2/client/visits/:visitId/magic-links` - Create visit access link
- [x] `GET /v2/client/post-visit-redirect` - Get post-visit redirect settings
- [x] `PATCH /v2/client/post-visit-redirect` - Update post-visit redirect settings
- [x] `GET /v2/client/patients/:patientId/visits` - List patient visits
- [x] `GET /v2/client/visits/:visitId` - Get visit detail
- [x] `GET /v2/client/conversations` - List conversations
- [x] `POST /v2/client/conversations` - Create conversation
- [x] `GET /v2/client/conversations/:conversationId` - Get or update conversation
- [x] `POST /v2/client/conversations/:conversationId/messages` - Send client-authored message
- [x] `POST /v2/client/conversations/:conversationId/messages` - Send patient-authored message
- [x] `PATCH /v2/client/conversations/:conversationId` - Update conversation status
- [x] `DELETE /v2/client/conversations/:conversationId` - Archive conversation
- [x] `POST /v2/client/conversations/:conversationId/escalations` - Escalate conversation to provider network
- [x] `GET /v2/client/conversations/:conversationId/messages` - List conversation messages
- [x] `GET /v2/client/conversations/:conversationId/messages/:messageId` - Get conversation message
- [x] `PATCH /v2/client/conversations/:conversationId/messages/:messageId` - Update conversation message
- [x] `DELETE /v2/client/conversations/:conversationId/messages/:messageId` - Delete conversation message
- [x] `GET /v2/client/prescriptions` - List prescriptions
- [x] `GET /v2/client/prescriptions/:prescriptionId` - Get prescription detail
- [x] `POST /v2/client/prescriptions/:prescriptionId/notification-rules` - Manage prescription notification rules
- [x] `GET /v2/client/prescriptions/:prescriptionId/notification-rules` - List prescription notification rules
- [x] `PATCH /v2/client/prescriptions/:prescriptionId/notification-rules/:ruleId` - Update prescription notification rule
- [x] `DELETE /v2/client/prescriptions/:prescriptionId/notification-rules/:ruleId` - Delete prescription notification rule
- [x] `POST /v2/client/payments/affiliate/sessions` - Create affiliate payment session
- [x] `POST /v2/client/payments/affiliate/session-completions` - Complete affiliate payment session
- [x] `GET /v2/client/payments/affiliate/session-status` - Get affiliate payment session status
- [x] `POST /v2/client/payments/affiliate/session-status` - Get affiliate payment session status with JSON body
- [x] `GET /v2/client/promocodes` - List promocodes
- [x] `GET /v2/client/promocodes/:code` - Get promocode by code
- [x] `PATCH /v2/client/promocodes/:code` - Update promocode (sync utmSlug or affiliate metadata)
- [x] `GET /v2/client/promocodes/validations` - Validate promocode for one or more products (read-only)
- [x] `POST /v2/client/promocodes/validations` - Validate promocode with JSON body
- [x] `PATCH /v2/client/business/branding` - Get or update business branding
- [x] `GET /v2/client/business/branding` - Get business branding
- [x] `PATCH /v2/client/business/payment-processor` - Get or update payment processor
- [x] `GET /v2/client/business/payment-processor` - Get payment processor
- [x] `PATCH /v2/client/business/checkout-options` - Get or update checkout options
- [x] `GET /v2/client/business/checkout-options` - Get checkout options
- [x] `GET /v2/client/branding` - Get client branding
