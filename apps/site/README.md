...
This keeps the marketing site static and CDN-served. If the site later needs
runtime server behavior, switch the Netlify command to `npm run build` and let
